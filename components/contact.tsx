      ...
      <div className="my-24">
        <div className="w-full lg:w-8/12 rounded-lg lg:border lg:border-gray-900 mx-auto flex items-center">
          <div className="m-8 flex flex-col md:flex-row justify-between">
            ...
            <form
              className="w-full md:w-1/2 my-8 flex flex-col gap-4" onSubmit={handleSubmit}
            >
              ...
              { state.succeeded ? (
              <p className="flex"><BadgeCheckIcon className="w-7 h-7 mr-2 text-green-500"/>
              Thanks for contacting. I will get back to you at the earliest possible</p>
              ):(
              <button
                type="submit"
